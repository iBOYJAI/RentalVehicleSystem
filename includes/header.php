    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <?php if (hasRole(ROLE_CUSTOMER)): ?>
                <a href="<?php echo BASE_URL; ?>pages/browse-vehicles.php" class="menu-item <?php echo $currentPage === 'browse-vehicles.php' ? 'active' : ''; ?>">
                    <i class="icon icon-view"></i> Browse Vehicles
                </a>
